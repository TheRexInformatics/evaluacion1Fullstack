...
export default function DashboardView({ loading, error, data, onRefresh, onNavigate }) {
  return (
    <main className="flex-1 overflow-y-auto p-6 space-y-6">
      ...
      <section className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div className="xl:col-span-2 bg-night-purple rounded-xl shadow-lg border border-lavender/10 overflow-hidden">
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-lavender/10">
      ...
      <section className="bg-night-purple rounded-xl shadow-lg border border-lavender/10 overflow-hidden">
        <div className="px-5 py-3.5 border-b border-lavender/10">
          <h3 className="text-sm font-semibold text-white">Actividad Reciente del Sistema</h3>
        </div>
        {loading ? (
...
function KpiSkeleton() {
  return (
    <div className="bg-night-purple rounded-xl shadow-sm border border-lavender/10 p-5 animate-pulse space-y-3">
