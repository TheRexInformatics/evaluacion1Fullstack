  ...
  return (
    <>
      <header className="bg-night-purple border-b border-lavender/10 px-6 py-3 flex items-center justify-between shrink-0">
        <div>
          <h1 className="font-pixelify text-white font-semibold text-lg leading-tight">{section}</h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 pl-3 border-l border-lavender/10">
            ...
            <button
              ...
              className="ml-1 p-1.5 rounded-lg text-white/30 hover:bg-tomato/15 hover:text-tomato transition-colors"
            >
